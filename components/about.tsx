...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-4">
        🚀 Senior Full Stack Developer (Front End Heavy) with more than 7 years of experience, I specialize in frontend technologies, particularly React.js, Angular, Next.js, and Vue.js. Proficient in JavaScript and TypeScript, I excel at creating dynamic and responsive user interfaces.
